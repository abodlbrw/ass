...
def xyz():
    ...
    print(f"")
    print(f"{BLUE}[01] {GREEN}    ")
    print(f"{BLUE}[00] {GREEN} ")
    print(f"")
    print(f"\033[1;91m========================================================")
    LUQMAN = input("[] CHOOSE : ")
    if LUQMAN in ["1","01"]:
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m       \033[0;m]")
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42m      :\033[0;m]")
    print(f"")
    ...
    print(f"          \x1b[97m[\033[37;41m          \033[0;m]")
    print(f"")
    limit = int(input('   : 1000, 2000, 5000, 10000\n\n   : '))
    ...
    with ThreadPool(max_workers=30) as yaari:    
        clear()
        tl = str(len(user))
        print(f" {BLUE}                   : {GREEN}"+tl)
        print(f" {BLUE}          : {GREEN}PAKISTAN ")
        print(f" {BLUE}          : {GREEN}"+code)
